          ...
          <div className="mr-auto place-self-center lg:col-span-7 content">
            ...
            {/* <Typewriter
              onInit={(typewriter: any) => {
                typewriter
                  .typeString("Discover the power of storytelling...")
                  .pauseFor(1500)
                  .deleteAll()
                  .typeString(
                    "How writing on your blog can change the world..."
                  )
                  .pauseFor(1500)
                  .deleteAll()
                  .typeString("Get started with reflactions...")
                  .pauseFor(1500)
                  .deleteAll()
                  .start();
              }}
