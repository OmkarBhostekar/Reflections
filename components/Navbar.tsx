      ...
      >
        <div className="container flex flex-wrap items-center justify-between mx-auto">
          ...
          <div className="hidden flex items-center md:block md:order-2">
            ...
            {!session && (
              <button className="inline-flex items-center justify-center px-3 py-1 mr-3 text-base font-semibold text-center text-white rounded-lg bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 dark:focus:ring-primary-900">
          ...
          <Nav.Collapse className="m-auto">
            <Nav.Link
              className="text-blue-600 dark:text-blue-600 md:hidden"
              href="/dashboard"
            >
              Dashboard
            </Nav.Link>
            <Nav.Link
              className="text-blue-600 dark:text-blue-600 hidden md:block"
              href="/dashboard"
            >
              Dashboard
            </Nav.Link>
