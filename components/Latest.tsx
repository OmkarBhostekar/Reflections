        ...
        <div className="grid gap-8 lg:grid-cols-2">
          {blogs.map((blog, id) => {
            return (
              <article
                key={id}
                className="card-zoom p-6 bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700"
              >
                <div className="flex justify-between items-center mb-5 text-gray-500">
                  ...
                  <span className="text-sm">{blog.dateOfPost}</span>
                </div>
