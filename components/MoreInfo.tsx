        ...
        <div className="gap-8 items-center py-8 px-4 mx-auto max-w-screen-xl xl:gap-16 md:grid md:grid-cols-2 sm:py-16 lg:px-6">
          ...
          <div className="mt-4 md:mt-0">
            ...
            <p className="mb-6 font-light text-gray-500 md:text-lg dark:text-gray-400">
              Welcome to Reflection, a community of bloggers dedicated to
              empowering voices and inspiring change. Our goal is to provide a
              platform for individuals to share their unique stories and
              experiences, and to create a space where those stories can be
